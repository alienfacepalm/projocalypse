...
import { ArchiveRestore, CheckSquare, ChevronDown, ChevronRight, Database, Download, LayoutGrid, Menu, Plus, Settings, Upload, X } from 'lucide-react'
...
export function Sidebar({ open, onClose }: SidebarProps) {
  ...
  async function handleImportTalemailBoard() {
    setImportError(null)
    const ok = await confirm({
      title: 'Import Talemail MVP board',
      description:
