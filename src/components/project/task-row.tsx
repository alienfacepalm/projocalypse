...
export function TaskRow({ task, draggable = true, compact = false }: TaskRowProps) {
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        'group flex items-center gap-2 border-b border-transparent px-3 hover:bg-muted/50',
        compact ? 'py-2' : 'py-1.5',
    ...
    >
      ...
      <button
        type="button"
        className={cn('flex-1 truncate text-left text-sm', task.completed && 'line-through text-muted-foreground')}
