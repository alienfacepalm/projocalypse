...
2. `packages/projocalypse/doc/MONOREPO.md` (or repo root `doc/MONOREPO.md` when dogfooding)
...
Use **`projocalypse-plan-sync`** skill and rule. Optional CI: `.github/workflows/plan-gap.yml` and `templates/cursor/automations/PLAN-GAP-WORKFLOW.md`.
